...
This folder contains local copies of the downloadable references I could identify from the working grammar notes.
...
## Online-only source cited by the notes

- Maria Suelí de Aguiar, "Dicionário bilíngue Noke Koĩ-Português / Português-Noke Koĩ."
  - [Online dictionary](https://publica.ciar.ufg.br/ebooks/noke-koi/index.html)
  - [Catalog record](https://portaldelivros.ufg.br/index.php/cegrafufg/catalog/book/465)
  - The catalog exposes this work as an HTML resource and lists the license as Creative Commons Attribution-NonCommercial-NoDerivatives 4.0 International.
